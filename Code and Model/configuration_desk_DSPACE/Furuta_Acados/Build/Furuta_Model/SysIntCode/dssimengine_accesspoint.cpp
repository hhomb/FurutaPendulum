...
/* -- Declarations of extern functions. -- */
 ...
 EXTERN_C_DECL void Furuta_Model_DSRTInitMdl(
    void);

 EXTERN_C_DECL void Furuta_Model_DSRTStartMdl(
    void);

 EXTERN_C_DECL void Furuta_Model_DSRTStopMdl(
    void);
...
pApp->setIoResourceMap(ErrorList, &g_ResourceMap);
    furuta_model_fcnModule_SIDRoot_TID1 = DsCFcnModule::create(ErrorList, pApp);
    furuta_model_fcnModule_SIDS7_TIDtriggered = DsCFcnModule::create(ErrorList, pApp);
    furuta_model_fcnModule_SIDS8_TIDtriggered = DsCFcnModule::create(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_Digital_Incremental_Encoder_In_i1_(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_Digital_Incremental_Encoder_In_i2_(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_Voltage_In_i1_(ErrorList, pApp);
ApSimEngineOnInitIoPreRtosInit_ctlcBODY_2_Voltage_Out_i1_(ErrorList, pApp);
...
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_Digital_Incremental_Encoder_In_i1_(ErrorList);
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_Digital_Incremental_Encoder_In_i2_(ErrorList);
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_Voltage_In_i1_(ErrorList);
ApSimEngineOnInitIoPostRtosInit_ctlcBODY_0_Voltage_Out_i1_(ErrorList);
...
ApSimEngineOnStartIo_ctlcBODY_0_Digital_Incremental_Encoder_In_i1_(ErrorList);
ApSimEngineOnStartIo_ctlcBODY_0_Digital_Incremental_Encoder_In_i2_(ErrorList);
ApSimEngineOnStartIo_ctlcBODY_0_Voltage_In_i1_(ErrorList);
ApSimEngineOnStartIo_ctlcBODY_0_Voltage_Out_i1_(ErrorList);
...
ApSimEngineOnStopIo_ctlcBODY_0_Voltage_Out_i1_(ErrorList);
...
ApSimEngineRunTimeInit(
    DsTErrorList ErrorList, Int32 calledOnStart) 
{
ApSimEngineRunTimeInit_ctlcBODY_0_Digital_Incremental_Encoder_In_i1_(ErrorList);
ApSimEngineRunTimeInit_ctlcBODY_0_Digital_Incremental_Encoder_In_i2_(ErrorList);
ApSimEngineRunTimeInit_ctlcBODY_0_Voltage_In_i1_(ErrorList);
ApSimEngineRunTimeInit_ctlcBODY_0_Voltage_Out_i1_(ErrorList);
if (calledOnStart)
{
}
