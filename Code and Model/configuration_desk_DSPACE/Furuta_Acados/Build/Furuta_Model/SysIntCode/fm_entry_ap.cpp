...
ap_entry_Furuta_Model_SIDRoot_TID1(
    void) 
{
    furuta_model_fcnModule_SIDRoot_TID1->updateInputs();
...
ap_entry_Furuta_Model_SIDS7_TIDtriggered(
    void) 
{
    furuta_model_fcnModule_SIDS7_TIDtriggered->updateInputs();
...
ap_entry_Furuta_Model_SIDS8_TIDtriggered(
    void) 
{
    furuta_model_fcnModule_SIDS8_TIDtriggered->updateInputs();
