...
# Variant: DEFAULT
APPL_VARS                         += DEFAULT
APPL_VAR_NAME_DEFAULT              = Furuta_Model_DEFAULT
APPL_VAR_OPT_Linkage_DEFAULT       = DEFAULT
APPL_VAR_RESULT_DIRPATH_DEFAULT    = "C:\Users\Administrator\Furuta\Furuta\Furuta_Acados\Build\Results.tmp"
...
INTERFACE_CC_SRC_FILES        += \
 ...
 dssimengine_accesspoint_Voltage_In.cpp \
 dssimengine_accesspoint_Voltage_Out.cpp

INTERFACE_CC_SRC_DIRPATHS     += \
 ".\..\SysIntCode" \
 ".\..\..\..\..\..\..\..\..\Program Files\dSPACE RCPHIL 2021-A\ConfigurationDesk\Implementation\EmbeddedSW\Src"
