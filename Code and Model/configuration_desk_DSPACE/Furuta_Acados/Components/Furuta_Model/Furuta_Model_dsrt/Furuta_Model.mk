...
BUILD_ERROR                    = [sprintf('DSRT MAKE ERROR: Make process failed for model Furuta_Model.')]
SYS_TARGET_FILE                = any
PROJ_MARKER_FILE               = no
...
DS_PROTECTION                     = OFF
MW_MAKEFILE                       = Furuta_Model.mk
MW_BUILDARGS                      =  MAT_FILE=0 COMBINE_OUTPUT_UPDATE_FCNS=0 INCLUDE_MDL_TERMINATE_FCN=1 MULTI_INSTANCE_CODE=0 OPTS="-DTID01EQ=1"
# MW_MATLAB_ROOT                  = "C:\Program Files\MATLAB\R2023a"
# MW_MATLAB_BIN                   = "C:\Program Files\MATLAB\R2023a\bin"
MATLAB_ROOT                       = C:\PROGRA~1\MATLAB\R2023a
MATLAB_BIN_ALT                    = C:\PROGRA~1\MATLAB\R2023a\bin
MW_RELEASE_VERSION                = R2023a
MW_RELEASE_VERSION               := $(MW_RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
# MW_COMPUTER                     = PCWIN64
MW_MODEL                          = Furuta_Model
MW_MODEL_MODULES                  = rt_matrx.c rt_printf.c Furuta_Model_data.c Furuta_Model_dsmpbap.c Furuta_Model_dsrtmdlfcn.c Furuta_Model_dsrtmf.c Furuta_Model_dsrttf.c Furuta_Model_dsrtvdf.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c furuta_expl_ode_fun.c furuta_expl_ode_hess.c furuta_expl_vde_adj.c furuta_expl_vde_forw.c acados_solver_furuta.c acados_solver_sfunction_furuta.c
# MW_MODEL_MODULES_OBJ            = rt_matrx.obj rt_printf.obj Furuta_Model_data.obj Furuta_Model_dsmpbap.obj Furuta_Model_dsrtmdlfcn.obj Furuta_Model_dsrtmf.obj Furuta_Model_dsrttf.obj Furuta_Model_dsrtvdf.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_zcfcn.obj furuta_expl_ode_fun.obj furuta_expl_ode_hess.obj furuta_expl_vde_adj.obj furuta_expl_vde_forw.obj acados_solver_furuta.obj acados_solver_sfunction_furuta.obj 
MW_S_FUNCTIONS                    = 
# MW_S_FUNCTIONS_OBJ              = 
MW_S_FUNCTIONS_LIB                = C:\Users\Administrator\acados_neu\buildDS1403\install\lib\libacados.a C:\Users\Administrator\acados_neu\buildDS1403\install\lib\libblasfeo.a C:\Users\Administrator\acados_neu\buildDS1403\install\lib\libhpipm.a
# MW_SOLVER                       = 
# MW_SOLVER_OBJ                   = 
MW_NUMST                          = 3
MW_TID01EQ                        = 1
...
MASTER_ANCHOR_DIR                 = 
START_DIR                         = C:\Users\Administrator\Furuta\Furuta\Furuta_Acados\Components\Furuta_Model
...
MW_MODELREFS                      = 
MW_MODELREF_LINK_RSPFILE          = Furuta_Model_ref.rsp
...
INTERFACE_LIB_$(LIB_BASENAME)_CC_SRC_FILES := Furuta_Model.$(MW_TARGET_LANG_EXT) 
